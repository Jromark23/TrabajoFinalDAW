<fieldset class="formulario__fieldset">
	...
	<?php if (isset($ponente->img_actual)) { ?>
		...
		<div class="formulario__imagen">
			...
			<picture>
				<source srcset="<?= $_ENV['HOST'] . '/public/build/img/speakers/' . $ponente->imagen; ?>.webp"
					type="image/webp">
				<source srcset="<?= $_ENV['HOST'] . '/public/build/img/speakers/' . $ponente->imagen; ?>.png"
					type="image/png">
				<img src="<?= $_ENV['HOST'] . '/public/build/img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen ponente">
			</picture>
